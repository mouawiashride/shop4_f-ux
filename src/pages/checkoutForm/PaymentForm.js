...
const PaymentForm = ({ checkoutToken, backStep, shippingData, onCaptureCheckout,handleEmptyCart }) => {
  ...
  const handleSubmit = async (event, elements, stripe) => {
    ...
    // onCaptureCheckout(checkoutToken.id, orderData); // there is error in api and the documentaion is bad
    setMessage('success');
    ResetCart();
   setTimeout(()=>{
